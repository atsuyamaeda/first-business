...
BASE COLOR: Matte sage green (#8AAE92) — soft, dusty, celadon-like.
BLOB COLOR: Salmon pink (#E8967D) — warm, earthy, terracotta-salmon tone. NOT bright orange. Think sunset-tinted clay.
...
BASE COLOR: Matte sage green (#8AAE92) — soft, dusty, celadon-like.
BLOB COLOR: Warm white / cream (#F5F0E8) — warm creamy tone like steamed milk or washi paper.

The blob is organic, watercolor-like, bleeding into the sage green. About 25-30% of lid surface, lower-right quadrant. The white creates a "fog" or "mist" effect dissolving into the green.

Typography color: dark green (#1B3A2C).

White blob is the most subtle and zen — fog over matcha fields at dawn.`,
  },

  // === SET 2: deep forest green base ===
  {
...
The blob is organic, watercolor-like, bleeding into the deep green. About 25-30% of lid surface, lower-right quadrant. The contrast between dark green and soft pink is DRAMATIC — like cherry blossoms at night (yozakura).

Typography color: white or very light pink.

Dark green + soft pink = high contrast, high fashion.`,
  },
  {
...
BASE COLOR: Deep matte forest green (#1B4332) — dark, rich, luxurious. Soft-touch finish.
BLOB COLOR: Salmon pink (#E8967D) — warm, earthy, terracotta-salmon.

The blob is organic, watercolor-like, bleeding into the deep green. About 25-30% of lid surface, lower-right quadrant.
...
BASE COLOR: Deep matte forest green (#1B4332) — dark, rich, luxurious. Soft-touch finish.
BLOB COLOR: Warm white / cream (#F5F0E8) — creamy, like steamed milk foam.

The blob is organic, watercolor-like, bleeding into the deep green. About 25-30% of lid surface, lower-right quadrant. The cream blob on dark green looks like matcha latte art.

Typography color: white.

The most MINIMAL and ELEGANT combination. Dark forest + white mist = ink painting.`,
  },

  // === SET 3: warm base + green blobs (inverted) ===
  {
...
BASE COLOR: Matte sakura pink (#F2C4C4) — soft, delicate cherry blossom pink.
BLOB COLOR: Sage green (#8AAE92) — soft, dusty celadon green.

The blob is organic, watercolor-like, bleeding into the pink. About 25-30% of lid surface, lower-right quadrant. Soft dissolving edges.

Typography color: dark green (#1B3A2C).

Pink base with green accent — playful inversion of the classic matcha palette.`,
  },
  {
...
BASE COLOR: Matte sakura pink (#F2C4C4) — soft, delicate cherry blossom pink.
BLOB COLOR: Deep forest green (#1B4332) — dark, rich, dramatic contrast.

The blob is organic, watercolor-like, bleeding into the pink. About 25-30% of lid surface, lower-right quadrant.

Typography color: dark green (#1B3A2C).

Pink + deep green = dramatic, bold inversion.`,
  },
  {
...
BASE COLOR: Matte salmon (#E8967D) — warm, earthy terracotta-salmon.
BLOB COLOR: Sage green (#8AAE92) — soft, dusty celadon green.

The blob is organic, watercolor-like, bleeding into the salmon. About 25-30% of lid surface, lower-right quadrant.

Typography color: dark green (#1B3A2C).

Salmon + sage = warm Mediterranean meets Japanese tea garden.`,
  },
  {
...
BASE COLOR: Matte salmon (#E8967D) — warm, earthy terracotta-salmon.
BLOB COLOR: Deep forest green (#1B4332) — dark, dramatic.

The blob is organic, watercolor-like, bleeding into the salmon. About 25-30% of lid surface, lower-right quadrant.

Typography color: dark green (#1B3A2C).

The most earthy, grounded combination — terracotta + forest.`,
  },
  {
...
async function main() {
  console.log("========================================");
  console.log("Color Blob — Wordmark Update (MATCHA&ME)");
  console.log("========================================\n");
